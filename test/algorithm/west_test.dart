...
void main() {
  ...
  group("WEST - Adjacent Tiles", () {
    const direction = RoverDirection.W;
    ...
    group("FRONT", () {
      test("Passed", () {
        ...
        const x = 1;
        const y = 1;
        final expected = State(x, y-1, direction, false);
    ...
    group("RIGHT", () {
      test("Passed", () {
        ...
        const x = 1;
        const y = 0;
        final expected = State(x-1, y, RoverDirection.N, false);
    ...
    group("LEFT", () {
      test("Passed", () {
        ...
        const x = 1;
        const y = 1;
        final expected = State(x+1, y, RoverDirection.S, false);
